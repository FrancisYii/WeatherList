package com.francis.weatherlist
...
class CustomAdapter : Adapter<CustomAdapter.CustomViewHolder>() {
    ...
    override fun onBindViewHolder(holder: CustomViewHolder, position: Int) {
        ...
        holder.dateTextView.text = "Date :${formatter.format(date)}"
        holder.weatherTextView.text = "weather: ${currentWeather.getJSONArray("weather")
            .getJSONObject(0).getString("main")}"
        holder.temperatureTextView.text = "Temperature :%.2f".format(currentWeather
            .getJSONObject("temp").getDouble("day")-273.15)+"C"
